...
export default function AlunoList({
              ...
              <div className="w-full">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1 font-semibold text-gray-900 truncate group-hover:text-emerald-900 transition-colors">
              ...
              <div className="w-full mt-2">
                ...
                <div className="flex items-center justify-between gap-1 mb-0.5">
                  ...
                  <div className="flex items-center gap-1.5 flex-1 min-w-0">
                    ...
                    <span
                      className="text-sm text-gray-600 truncate group-hover:text-emerald-800 transition-colors"
                      title={turma}
                    >
                      {turma}
  ...
  return (
    <div className="px-1 sm:px-3 mt-3">
      {/* Cabeçalho mais compacto */}
      <div className="page-section-card flex justify-between items-center mb-3 px-3 py-2">
        <div>
          <h2 className="text-base font-semibold text-gray-900">Lista de alunos</h2>
        </div>
        <ContadorLista
          total={alunos.length}
          className="px-2.5 py-1 rounded-full border border-emerald-200 bg-emerald-100 text-emerald-900 text-xs font-semibold"
        />
      </div>
      ...
      {carregando ? (
        ...
        <div className="page-section-card divide-y overflow-hidden">
