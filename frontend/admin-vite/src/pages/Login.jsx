      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-cor-secundaria rounded-2xl shadow-xl overflow-hidden border border-cor-primaria/20">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-cor-clara mb-1">
                E-mail
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="senha" className="block text-sm font-medium text-cor-clara mb-1">
                Senha
              </label>
              <input
                id="senha"
            ...
            <div className="pt-4">
              <button
                ...
                className={`w-full flex justify-center items-center gap-2 ${
                  carregando ? 'bg-cor-primaria/70' : 'bg-cor-primaria hover:bg-cor-destaque'
                } text-cor-escura font-bold py-3 px-4 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg`}
              >
                {carregando ? (
                  <>
                    <svg className="animate-spin -ml-1 mr-2 h-5 w-5 text-cor-escura" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        {/* <div className="mt-6 text-center">
          <a href="#" className="text-sm text-cor-primaria hover:underline">
            Esqueceu sua senha?
          </a>
        </div> */}
      </div>
