...
async function getOrganizacaoPublica(req, res) {
    try {
        ...
        logger.debug(`[organizacaoPublicController] Organização pública encontrada: ${org.nome_fantasia} (org ${org.id})`);
        return res.json({
        ...
        logger.error("[organizacaoPublicController] Erro ao buscar organização pública:", err.message);
