...
async function listarGraduacoesPublic({ categoriaId, organizacaoId }) {
    try {
        logger.debug("[preMatriculasGraduacoesRepository] Listando graduações públicas", { categoriaId, organizacaoId });
    ...
    `, [categoriaId, organizacaoId]);
        ...
        logger.error("[preMatriculasGraduacoesRepository] Erro ao listar graduações:", err.message);
        throw err;
    }
}
module.exports = {
