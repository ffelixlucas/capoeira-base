...
if (FIREBASE_PROJECT_ID &&
    ...
    logger.log("Ambiente de produção detectado. Usando variáveis de ambiente para Firebase.");
}
else {
...
if (serviceAccount && storageBucketName) {
    ...
    logger.log("Firebase Admin SDK inicializado com sucesso com bucket:", storageBucketName);
}
else {
